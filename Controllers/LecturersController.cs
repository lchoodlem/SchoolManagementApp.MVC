...
namespace SchoolManagementApp.MVC.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public LecturersController(SchoolMgmtDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Lecturers != null ? 
                          ...
                          Problem("Entity set 'SchoolMgmtDbContext.Lecturers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolMgmtDbContext.Lecturers'  is null.");
            }
            var lecturer = await _context.Lecturers.FindAsync(id);
            if (lecturer != null)
            {
